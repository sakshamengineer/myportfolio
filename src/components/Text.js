    ...
    return (
        <div className='container-txt'>
            <div className='text-left'>
                ...
                <a href="https://drive.google.com/file/d/1wLcRtRafIduD2S8o4BHkm3jqiHaDOsQo/view?usp=sharing"  target="_blank" className='animate-btn' rel="noreferrer"><button>Download CV</button></a>
            </div>
            <div className="right">
